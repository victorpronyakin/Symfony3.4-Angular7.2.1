...
@Component({
  selector: 'app-user-broadcasts-history-preview',
  templateUrl: './user-broadcasts-history-preview.component.html',
  styleUrls: ['./user-broadcasts-history-preview.component.scss']
})
export class UserBroadcastsHistoryPreviewComponent implements OnInit {
