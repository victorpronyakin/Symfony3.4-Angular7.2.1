...
@Component({
  selector: 'app-user-growth-tools-flow-edit',
  templateUrl: './user-growth-tools-flow-edit.component.html',
  styleUrls: ['./user-growth-tools-flow-edit.component.scss']
})
export class UserGrowthToolsFlowEditComponent implements OnInit {
