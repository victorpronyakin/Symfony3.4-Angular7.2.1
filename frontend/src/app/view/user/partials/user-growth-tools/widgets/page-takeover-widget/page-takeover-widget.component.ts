...
@Component({
  selector: 'app-page-takeover-widget',
  templateUrl: './page-takeover-widget.component.html',
  styleUrls: [
    './page-takeover-widget.component.scss',
    '../../../../../../../assets/scss/widget.scss'
  ]
})
export class PageTakeoverWidgetComponent implements OnInit, OnChanges {
  @Input() public config;
  @Input() public view;
