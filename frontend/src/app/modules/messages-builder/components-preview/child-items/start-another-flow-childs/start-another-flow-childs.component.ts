...
@Component({
  selector: 'app-start-another-flow-childs',
  templateUrl: './start-another-flow-childs.component.html',
  styleUrls: ['./start-another-flow-childs.component.scss']
})
export class StartAnotherFlowChildsComponent extends DragNDropComponent implements OnInit {
